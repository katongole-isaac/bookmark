...
import BookmarkLogo from "../bookmark/images/logo-bookmark.svg";
...
export default function Navbar() {
  ...
  const handleNavClose = () => {
    ...
    //open nav on sm screens.
    setshowBtn(true);
  };

  return (
    <>
      <nav className={`nav ${showBtn ? "nav-on-small" : null}  `} ref={navRef}>
        <div className="container nav-bar ">
          <div className="brand">
            ...
            <div className="img-wrapper" role="button">
              {!showBtn ? (
                <label htmlFor="chck">
                  <img
                    src={HamburgerIcon}
